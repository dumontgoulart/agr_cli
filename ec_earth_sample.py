...
DS_y_lr = xr.open_dataset("EC_earth_PD/epic_soy_yield_us_lr.nc",decode_times=True)
mask_ref = DS_y_lr['yield'].mean('time') 

# CRU data
DS_t_max_cru = xr.open_dataset("EC_earth_PD/cru_ts4.04.1901.2019.tmx.dat_lr.nc",decode_times=True).sel(time=slice('31-12-1989', '31-12-2020'))
DS_t_max_cru_us = DS_t_max_cru.where(mask_ref > -0.1 ) # mask

DS_dtr_cru = xr.open_dataset("EC_earth_PD/cru_ts4.04.1901.2019.dtr.dat_lr.nc",decode_times=True).sel(time=slice('31-12-1989', '31-12-2020'))
DS_dtr_cru_us = DS_dtr_cru.where(mask_ref > -0.1 )

DS_pre_cru = xr.open_dataset("EC_earth_PD/cru_ts4.04.1901.2019.pre.dat_lr.nc",decode_times=True).sel(time=slice('31-12-1989', '31-12-2020'))
DS_pre_cru_us = DS_pre_cru.where(mask_ref > -0.1 )

DS_cru_merge = xr.merge([DS_t_max_cru_us.tmx, DS_dtr_cru_us.dtr, DS_pre_cru_us.pre])
...
def compound_analysis(df_features_ec_season, y_pred):
    ...
    sns.lmplot(data=df_features_ec_season_fail, y="dtr_7_8", x="precip_7_8",fit_reg=True, scatter_kws={"s": 10}, hue='Failure',legend_out=False)
    ...
    plt.show()
    sns.lmplot(data=df_features_ec_season_fail, y="tmx_7_8", x="precip_7_8",fit_reg=True, scatter_kws={"s": 10}, hue='Failure',legend_out=False)
    ...
    plt.title("Scatter plot and regression line")
    plt.show()
    sns.lmplot(data=df_features_ec_season_fail, y="tmx_7_8", x="dtr_7_8",fit_reg=True, scatter_kws={"s": 10}, hue='Failure',legend_out=False)
